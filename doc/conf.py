...
#
# SessPy documentation build configuration file, created by
...
latex_documents = [
  ('index', 'SessPy.tex', u'SessPy Documentation',
   u'Mark Nevill', 'manual'),
]
...
man_pages = [
    ('index', 'sesspy', u'SessPy Documentation',
     [u'Mark Nevill'], 1)
]
